...
USE Bichomon;
CREATE TABLE Especie(nombre VARCHAR(30), tipo VARCHAR(20), altura INT,peso FLOAT, cantidad_de_bichos INT, PRIMARY KEY(nombre));
...
#NOTA
#----
##Cambié algunos nombre de columnas porque estaban en cammel case, ahora están con guión bajo.
